...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2023 at 11:30 AM
...
CREATE TABLE `tbl_user` (
  ...
  `hak_akses` enum('Administrator','Gudang','Owner','Sales') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_user` (`id_user`, `nama_user`, `username`, `email`, `password`, `hak_akses`) VALUES
(1, 'Joni', 'admin', '', '$2y$12$Yi/I5f1jPoQNQnh6lWoVfuz.RtZ3OHcKN6PU.I62P0fYK1tJ7xMRi', 'Administrator'),
(2, 'Pak bowo', 'gudang', '', '$2y$12$BeRYh13zfPXej97VgcfeNucYJGTElha5sRyIUQm1278D2u2Aqf6DS', 'Gudang'),
(3, 'Mekel', 'owner', '', '$2y$12$odXcPs.RLJJH6Ghv3s42c.5zg5qAOz/S3Adr0lXGNcVSJ6f1hHS6G', 'Owner'),
(4, 'sono', 'sales', 'sales@gmail.com', '$2y$12$hoDXZKryR2zKEyYDUqHD.Oqxd1ho9hK9A9SDFRjAEC86nwSLPLLES', 'Sales');
